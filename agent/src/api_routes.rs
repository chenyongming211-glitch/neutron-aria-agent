...
pub fn build_router(control_plane: Arc<ControlPlane>) -> Router {
    Router::new()
        ...
        .route("/api/v1/{instance}/groups/with_stats", get(api_handlers::list_groups_with_stats))
        ...
        .route("/api/v1/{instance}/qos/with_stats", get(api_handlers::list_qos_with_stats))
        .route("/api/v1/{instance}/mirror", get(api_handlers::list_mirror).post(api_handlers::add_mirror).delete(api_handlers::delete_mirror))
        .route("/api/v1/{instance}/mirror/with_stats", get(api_handlers::list_mirror_with_stats))
        ...
        .route("/api/v1/{instance}/tcprt/histogram", get(api_handlers::tcprt_histogram))
        .route("/api/v1/{instance}/tcprt/states", get(api_handlers::tcprt_states))
        .route("/api/v1/{instance}/ssl", get(api_handlers::list_ssl).delete(api_handlers::flush_ssl))
        .route("/api/v1/{instance}/ssl/http", get(api_handlers::list_ssl_http).delete(api_handlers::flush_ssl_http))
