...
Run: `20260630155334`
Temporary VM: `aria-n05-guestprobe-20260630155334` / `192.0.2.40`
...
- DHCP initial request/lease: pass. Guest `eth0` received dynamic IPv4
  `192.0.2.40/25`, and `service-logs.txt` shows `DHCPOFFER`,
...
- Metadata network path: pass/degraded. The guest has a route to
  `169.254.169.254` via `192.0.2.24`, and the Neutron metadata namespace proxy
