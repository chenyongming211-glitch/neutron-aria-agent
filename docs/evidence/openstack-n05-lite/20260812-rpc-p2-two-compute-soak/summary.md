...
Scope: the declared active two-compute topology. The unavailable former third
compute is not part of this
acceptance claim.
...
| --- | ---: | ---: | ---: | ---: | --- |
| `compute-a` | 30 | 23 | 3940 | 1 | pass |
| `compute-b` | 30 | 14 | 3298 | 2 | pass |
...
was not restarted. The `ovs-vswitchd` PIDs remained unchanged on both
computes. Neither OVS nor `neutron_openvswitch_agent` was modified or
restarted.
