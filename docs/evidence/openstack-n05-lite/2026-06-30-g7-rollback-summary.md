...
| Area | Result |
| --- | --- |
| Baseline connectivity | `10.58.159.26` was reachable from `ostack2.bj159.net` before the smoke. |
| ACL active traffic | Full-resync generation `81` managed five local compute tap ports. ICMP from `10.58.159.2/32` to VM port `86b83885-671f-474c-9556-8af98cf1cdc8` / `tap86b83885-67` was blocked by the smoke ACL. |
...
| Post-rollback connectivity | `10.58.159.26` was reachable again after rollback. |
...
- VM -> external active direction evidence is covered by the later temporary
  ...
  The `20260630121023-ostack2.bj159.net` probe remains recorded as a rejected
