...
4. **Field evidence pending — Isolate ACL selector ownership:**
   ...
   implementation commit `49081c6` and checker/CI head `65b1dc5` passed
   `fast-contracts`, `rust-behavior`, and `rust-build` in exact-head Actions run
   ...
   remains not fixed and the PR remains Draft.
