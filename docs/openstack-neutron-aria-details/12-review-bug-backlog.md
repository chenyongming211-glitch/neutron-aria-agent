...
and withdrew none. Batch 1 (`REVIEW-ACL-106`, `REVIEW-ACL-107`) and
Batch 2 (`REVIEW-ACL-108/109/110`, `REVIEW-TXN-038`) closed the same day
with exact RED/GREEN CI evidence.
