...
Batch 2 (`REVIEW-ACL-108/109/110`, `REVIEW-TXN-038`), Batch 3
(`REVIEW-ACL-101/102`, `REVIEW-TXN-037`), and Batch 4
(`REVIEW-ACL-104/105`) closed the same day with exact RED/GREEN CI
evidence.
