...
11. **Complete evidence and lower-risk hardening:** `REVIEW-ACL-007` is fixed
    ...
    target Neutron 9/Python 2 execution remains `deferred/pending`.
    Also close
