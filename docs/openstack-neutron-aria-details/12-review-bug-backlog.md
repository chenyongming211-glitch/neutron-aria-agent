...
12. **In progress — 2026-08-13 full-code bug-hunt batch:** 33 findings recorded as
    ...
    four ordinary open P1 (`REVIEW-ACL-077`, `REVIEW-TXN-031/032`, and
    `REVIEW-OPS-038`); `REVIEW-ACL-075/076` have source implementation and
    hosted CI complete with target-kernel evidence pending;
    `REVIEW-TXN-033` remains P2 with an escalation path;
