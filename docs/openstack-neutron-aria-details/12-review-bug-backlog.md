...
and withdrew none. Batch 1 (`REVIEW-ACL-106`, `REVIEW-ACL-107`),
Batch 2 (`REVIEW-ACL-108/109/110`, `REVIEW-TXN-038`), and Batch 3
(`REVIEW-ACL-101/102`, `REVIEW-TXN-037`) closed the same day with exact
