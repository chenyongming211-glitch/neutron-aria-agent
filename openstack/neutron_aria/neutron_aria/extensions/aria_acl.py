...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    RESOURCE_COLLECTIONS["port_statuses"]: {
        ...
        "counters_sampled_at": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_packets": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_bytes": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_allow_packets": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_dropped_packets": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_dropped_bytes": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_policy_pps": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_drop_packets": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_drop_bytes": {"allow_post": False, "allow_put": False, "is_visible": True},
        "counters_drop_pps": {"allow_post": False, "allow_put": False, "is_visible": True},
